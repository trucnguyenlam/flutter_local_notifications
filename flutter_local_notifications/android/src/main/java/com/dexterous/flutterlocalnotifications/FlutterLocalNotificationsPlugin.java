...
public class FlutterLocalNotificationsPlugin implements MethodCallHandler, PluginRegistry.NewIntentListener, FlutterPlugin, ActivityAware {
    ...
    protected static Notification createNotification(Context context, NotificationDetails notificationDetails) {
        ...
        PendingIntent pendingIntent = PendingIntent.getActivity(context, notificationDetails.id, intent, getPendingIntentFlags());
    ...
    private static void scheduleNotification(Context context, final NotificationDetails notificationDetails, Boolean updateScheduledNotificationsCache) {
        ...
        PendingIntent pendingIntent = PendingIntent.getBroadcast(context, notificationDetails.id, notificationIntent, getPendingIntentFlags());
    ...
    private void cancelNotification(Integer id, String tag) {
        ...
        PendingIntent pendingIntent = PendingIntent.getBroadcast(applicationContext, id, intent, getPendingIntentFlags());
    ...
    private void cancelAllNotifications(Result result) {
        ...
        for (NotificationDetails scheduledNotification :
            ...
            PendingIntent pendingIntent = PendingIntent.getBroadcast(applicationContext, scheduledNotification.id, intent, getPendingIntentFlags());
            AlarmManager alarmManager = getAlarmManager(applicationContext);
            alarmManager.cancel(pendingIntent);
        }
